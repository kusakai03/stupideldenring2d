...
public class Arc0CS : MonoBehaviour
{
    ...
    [SerializeField] private List<ItemDrop> startWeapons;
    ...
    private void CutsceneState(){
        ...
        switch(endOfLinesCount){
            ...
            break;
            case 5:
            GameSetting.Instance.SelectReward(startWeapons);
            PlayerManager.Instance.Respawn();
            break;
        }
    }
    public void ConfirmName(){
        GameSetting.Instance.ShowConfirmMessage(confirmMessage, NameEntered);
    }
