...
public class PlayerAnimation : MonoBehaviour
{
    ...
    [SerializeField] private AnimationClip[] spearAnim;
    [SerializeField] private AnimationClip[] hammerAnim;
    ...
    private void UpdateAnimation(){
        ...
        if (at.weapon1 != null){
            switch (PlayerManager.Instance.GetEquipmentByID(at.weapon1.eid).weapon.weaponType){
                ...
                break;
                case "Spear":
                UpdateAnimationState(statename, spearAnim);
                break;
                case "Hammer":
                UpdateAnimationState(statename, hammerAnim);
                break;
            }
        }
    }
    public void UpdateAnimationState(string[] animationState, AnimationClip[] clip)
    {
        ...
        {
            overrideController[animationState[i]] = clip[i];
        }
