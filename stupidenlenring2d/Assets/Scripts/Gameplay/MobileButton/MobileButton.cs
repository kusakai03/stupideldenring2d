...
public class MobileButton : MonoBehaviour
{
    ...
    {
        weaponIcon.sprite = PlayerManager.Instance.GetEquipmentByID(player.GetComponent<PlayerAttribute>().weapon1.eid).eImage;
    }
    ...
    public void ShowInterractButton(DialogueLines lines){
